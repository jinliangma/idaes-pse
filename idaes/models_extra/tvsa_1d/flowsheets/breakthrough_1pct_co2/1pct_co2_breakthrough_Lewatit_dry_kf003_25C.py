...
def get_model(dynamic=True, time_set=None, nstep=None, init=True):
    ...
    m.fs.FB.bed_height.fix(0.01074*1.35) # adjusted height since exact bed weight is reported to be approximately 200 mg
...
def main_dynamic():
    ...
    write_dynamic_results_to_csv(m_dyn, "Lewatit_1pct_dry_result_25C.csv")
    # plot figures
    time = []
