...
def get_model(dynamic=True, time_set=None, nstep=None, init=True):
    ...
    m.fs.FB.kf["CO2"] = 0.0008
    m.fs.FB.kf["H2O"] = 0.003
    ...
    m.fs.FB.heat_transfer_coeff_fluid_wall = 1.0 # 220 in Young's paper, use very low value for adiabatic case
    ...
    m.fs.Inlet_Valve.inlet.mole_frac_comp[:, "H2O"].fix(0.002)
    m.fs.Inlet_Valve.inlet.mole_frac_comp[:,  "N2"].fix(0.997999)
